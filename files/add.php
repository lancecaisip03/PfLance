...
<?php } ?>
    ...
    <div class="navbar">
        ...
        <a   href="login.php"><?php if (isset($_SESSION['user_id'])) { ?> Profile <?php } ?> <?php if (!isset($_SESSION['user_id'])) { ?> Login <?php } ?></a>
        <a   class="active" href="login.php"><?php if (isset($_SESSION['user_id'])) { ?> Add Link <?php } ?> <?php if (!isset($_SESSION['user_id'])) { ?> Login <?php } ?></a>
    </div>
